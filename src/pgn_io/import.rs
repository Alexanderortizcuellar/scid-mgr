...
use super::encoder::{
    encode_scid_move_byte, standard_piece_slots, update_piece_slots, ENCODE_END_GAME,
};
use super::types::{FastNameTables, ImportProgress, RawPgnTags};
    ...
    F: FnMut(&ImportProgress),
{
    ...
    let res = import_pgn_ultra_fast(&index_path, pgn_path, format, progress_cb)?;
