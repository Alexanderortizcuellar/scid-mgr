...
| :-: | :--- | :--- | :---: | :--- |
| **01** | [**`01_WHAT_IF_FILTER_PLAN.md`**](./01_WHAT_IF_FILTER_PLAN.md) | `what_if` Board Sandbox | 📋 Ready for Dev | Speculative board mutations: `remove`, `pass`, `swap`, `swap_color`, `move`, `add`, `turn`, `[...]`. |
